            ...
            <div className="absolute inset-0 flex items-center justify-center md:justify-start p-8 md:p-16">
              <div className="max-w-2xl">
                <h2 className="font-serif text-4xl sm:text-5xl font-bold mb-6">
                  <span className="text-rose-400 font-didot">deep dive</span>
                  <br />
                  <span className="text-rose-400 font-didot">into...</span>
                  <br />
                  <span className="text-rose-400 font-didot">secrets of youth</span>
                </h2>
