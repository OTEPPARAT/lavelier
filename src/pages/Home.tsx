  ...
  return <main className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute top-0 left-0 right-0 h-1/2 pointer-events-none">
          {[...Array(3)].map((_, i) => <div key={i} className="absolute inset-0 animate-shimmer" style={{
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          size: 8,
          delay: 2.5
        }].map((bubble, i) => <div key={i} className="absolute bottom-0 rounded-full animate-bubble" style={{
          left: bubble.left,
...
for your skin's timeless beauty."</p>
      ...
      <section className="py-20 relative overflow-hidden bg-gradient-to-b from-cyan-950/50 via-blue-950/60 to-slate-950/70">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute w-96 h-96 rounded-full blur-3xl animate-pulse" style={{
          background: 'radial-gradient(circle, rgba(255, 248, 220, 0.15), transparent)',
          top: '10%',
          left: '10%',
          animation: 'float 8s ease-in-out infinite'
        }} />
          <div className="absolute w-80 h-80 rounded-full blur-3xl animate-pulse" style={{
          background: 'radial-gradient(circle, rgba(255, 253, 240, 0.12), transparent)',
          top: '60%',
          right: '15%',
          animation: 'float 10s ease-in-out infinite 2s'
        }} />
          <div className="absolute w-72 h-72 rounded-full blur-3xl animate-pulse" style={{
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="glass-card p-8 rounded-2xl text-center group hover:scale-105 transition-transform overflow-hidden">
              ...
              <div className="inline-block p-4 rounded-full mb-6 group-hover:animate-wave" style={{
              backgroundColor: 'rgba(106, 142, 163, 0.25)'
            }}>
                <Droplets className="w-8 h-8" style={{
                color: '#6A8EA3'
              }} />
              </div>
              <h3 className="font-didot text-2xl font-semibold mb-4" style={{
              color: '#6A8EA3'
            }}>
                Deep Sea Treasures
              </h3>
            ...
            <div className="glass-card p-8 rounded-2xl text-center group hover:scale-105 transition-transform overflow-hidden">
              ...
              <div className="inline-block p-4 rounded-full mb-6 group-hover:animate-wave" style={{
              backgroundColor: 'rgba(77, 102, 94, 0.25)'
            }}>
            ...
            <div className="glass-card p-8 rounded-2xl text-center group hover:scale-105 transition-transform overflow-hidden">
              ...
              <div className="inline-block p-4 rounded-full mb-6 group-hover:animate-wave" style={{
              backgroundColor: 'rgba(154, 120, 115, 0.25)'
            }}>
            ...
            <div className="glass-card p-8 rounded-2xl text-center group hover:scale-105 transition-transform overflow-hidden">
              ...
              <div className="inline-block p-4 rounded-full mb-6 group-hover:animate-wave" style={{
              backgroundColor: 'rgba(172, 137, 77, 0.25)'
            }}>
                <Crown className="w-8 h-8" style={{
                color: '#AC894D'
              }} />
              </div>
              <h3 className="font-didot text-2xl font-semibold mb-4" style={{
      ...
      <section className="relative py-0 overflow-hidden">
        <div className="relative h-[700px] md:h-[800px] w-full">
          <img src={underwaterImage} alt="Deep sea beauty" className="w-full h-full object-cover" style={{
      ...
      zIndex: 9999
        ...
        <img src={coralRed} alt="Red Coral" className="w-full h-full object-contain" />
      </div>
    </main>;
};
export default Home;